...
```{r pdp-bike, message=FALSE, warning=FALSE, fig.cap="Separated bike lanes show the strongest speed-reducing association."}
...
p_bike_bar <- ggplot(modeling_data, aes(x = fct_relevel(bike_lane_status,
...
The model estimates a potential modest impact of separated bike lanes on speeding. Interestingly, sharrows, if anything, are predicted to increase speeding (though the size of the effect is small compared to the average model error).
