...
```{r Construct modeling data outputs}

speed_summary_all_speeding <- speed_data_analysis %>% 
...
speed_summary_high_speeding <- speed_data_analysis %>% 
...
# box_save_rds(speed_modeling_data, file_name = "speed_modeling_data_v1.rds", dir_id = box_processed_data_folder)
